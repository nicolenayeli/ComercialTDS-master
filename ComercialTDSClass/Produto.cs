...
namespace ComercialTDSClass
{
    public class Produto
    {
        ...
        public byte[] Imagem{ get; set; } // a Imagem do banco vem como objeto pro C#,[] Não significa
        // que você esta anexando a imagem ali e sim para indicar do parenteses para a imagem, ele
        // ele transforma em uma sequencia de matriz de bytes
